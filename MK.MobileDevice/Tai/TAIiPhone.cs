namespace MK.MobileDevice.TAI
{
    ...
    public unsafe class TAIiPhone
    {
        ...
        public TAIiPhone(ConnectEventHandler myConnectHandler, ConnectEventHandler myDisconnectHandler)
        {
            this.wasAFC2 = false;
